...
<head>
    ...
    <title>SPK Padi Resort - Edit Data Alternatif</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Alternatif</h1>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form action="{{ route('alternatif.update', ['alternatif' => $dataalternatif->id]) }}" method="POST">
                                @csrf 
                                @method('PUT')
                                <div class="form-group mt-2">
                                <label for="nama_alternatif" class="form-label font-weight-bold">Nama Alternatif</label>
                                <input type="text" name="nama_alternatif" class="form-control" value="{{ $dataalternatif->nama_alternatif }}">
                                </div>
